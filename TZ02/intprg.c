...
//  vector 14 IRQ0
__interrupt(vect=14) void INT_IRQ0(void) {SW1_Motor_OFF();}
//  vector 15 IRQ1
__interrupt(vect=15) void INT_IRQ1(void) {SW2_Motor_Reverse();}
//  vector 16 IRQ2
__interrupt(vect=16) void INT_IRQ2(void) {SW3_Motor_25();}
//  vector 17 IRQ3
__interrupt(vect=17) void INT_IRQ3(void) {SW4_Motor_75();}
//  vector 18 WKP
