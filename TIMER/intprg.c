...
//  vector 14 IRQ0
__interrupt(vect=14) void INT_IRQ0(void) {timerSet(1);}
//  vector 15 IRQ1
__interrupt(vect=15) void INT_IRQ1(void) {timerSet(2);}
//  vector 16 IRQ2
__interrupt(vect=16) void INT_IRQ2(void) {timerSet(3);}
//  vector 17 IRQ3
__interrupt(vect=17) void INT_IRQ3(void) {timerStart();}
//  vector 18 WKP
...
//  vector 29 Timer B1
__interrupt(vect=29) void INT_TimerB1(void) {countPerSec();}
//  vector 30 Reserved
